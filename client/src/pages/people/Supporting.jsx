...
const Supporting = () => {
   ...
   const [stats, setStats] = useState({ programs: 0, teachers: 0, research: 0 });
    const [facultyData, setFacultyData] = useState([]);
         ...
         useEffect(() => {
            setTimeout(() => {
              setStats({ programs: 3, teachers: 19, research: 43 });
            }, 1000);
          }, []);
  ...
  return (
    <>
    <PageBanner breadcrumb="Home / People / Supporting Staff" />
     <HeroTemplate stats={stats}/>

    <section className="py-14 mt-10 px-6 sm:px-10 md:px-20 lg:px-30 bg-gray-50">
      {/* Heading */}
      <div className="mb-8">
        <h2 className="text-3xl font-stretch-50% text-gray-900 mb-3">Teaching Supporting Staff</h2>
